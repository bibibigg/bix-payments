export function PostTableSkeleton() {
  return (
    <div className="overflow-hidden rounded-xl border border-gray-200 bg-white">
      <div className="grid grid-cols-[64px_112px_1fr_96px] gap-4 px-5 py-3 bg-gray-50 border-b border-gray-200">
      ...
      {Array.from({ length: 8 }).map((_, i) => (
        <div
          key={i}
          className="grid grid-cols-[64px_112px_1fr_96px] gap-4 px-5 py-3.5 border-b border-gray-100 last:border-b-0 items-center"
        >
